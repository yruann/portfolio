document.addEventListener("DOMContentLoaded", () => {
    ...
    // };
    const wordBanks = {
        "w1": ["them","ing","say","where","your","out","with","they","repetition","?", "birth","although","is","we","compose","ingest","children","many","those","do","exhaust","change","become","ed","she","selfish","fragment","subject","self","yes","es", "choice","between","the","intertwine","of", "-", "be","so","while","know","over","tion","my","yet", ",", "subjugate","me","to","autonomy","that","and","i", ",", "who","but","god","a", "s", "spine","old","deteriorate","there","am","make","need","what","a","no","shape","other","complete","d","you","pain","restore",":", "will","for","ever","new","entrails","our","humiliate", ")", "visceral","seek","how","all","'","narrative",".", "feel","child","hold","just","their","far","even","ion","it","when","like","though","re","from","s","cradle","an","continue","have","nor","take",".", "memory","store","about","ance","to","want","her","or","why","piece","try","n","being","core","does","of","these","mother","ful","not","always","to", "as", "at", "end", ".", "the", "sound", "near", "every","less", "conscious", "ious", "her","d", "ous", "y", "ly", "subject", "as", "bear", "exert","labor", "on", "ness", "human", "post","?", "corporeal","mass", "tethered","chest","weight","-", "mirror","capacity","physical","state","dependent","experience","manifest","collect","fluid","existence","exist","]","ence","organic","bodily","recall", "(", "source","true ","world", "reality","archive","construct","rather",";", "connect","creature","under","understand","without","realize","really","right","are", "[", "keep","did", "one", "this", "may", "in", "entity","of","just","simply","on","something","'", "romantic", "blood", "body", "same", "have", "specimen", "power", "digital", "would"]
    };
